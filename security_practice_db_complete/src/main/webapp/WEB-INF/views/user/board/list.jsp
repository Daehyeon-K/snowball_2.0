		...
		<div class="container-fluid px-4">
			...
			<div class="col-md-12" style="padding-left: 10px;">
				<div class="col-md-8" style="padding-left: 0px;">
					...
					<form action="" method="get" id="searchForm">
						...
						<input type="hidden" name="amount" value="${cri.amount}" /> 
							...
							<option value="W"
								<c:out value="${cri.type == 'W' ? 'selected':'' }"/>>사용자ID</option>
							<option value="TC"
					...
					<tbody>
						<c:forEach var="blist" items="${boardList}">
							<tr>
								...
								<td>${blist.mem_id}</td>
								<td><a
									href="/user/board/readrow?board_id=${blist.board_id}">${blist.board_title}</a></td>
				...
				<button type="button" class="btn btn-primary"
					onclick="location='/user/board/create'">글작성</button>
				...
				<div class="text-center">
					<ul class="pagination">
						...
						<c:forEach var="idx" begin="${pageDto.startPage}"
							...
							<li
								class="paginate_button ${pageDto.cri.pageNum == idx?'active':''}"><a
								href="${idx}">${idx}</a></li>
						</c:forEach>

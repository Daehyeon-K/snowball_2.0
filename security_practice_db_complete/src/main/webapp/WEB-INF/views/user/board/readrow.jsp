				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="form-group">
								<label for="">내용</label> <input type="text" name="reply_content"
									id="" class="form-control" placeholder="댓글 내용" />
							</div>
							<div class="form-group">
						...
						<div class="modal-footer">
							...
							<button type="button" class="btn btn-primary" id="modalCloseBtn"
								data-dismiss="modal"
								onclick="location.href='/user/board/readrow?board_id=${dto.board_id}'">종료</button>
						</div>
					</div>
				</div>
			</div>
